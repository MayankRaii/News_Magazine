...
host="dpg-cnmq90qcn0vc738fh5v0-a", database="news_magazine", user="news_magazine_user", password="kcbYdr8UYXTE8jIdK9cw0Sh1KEiR56BS")
cur=conn.cursor()
...
def protected():
    if 'google_token' in session:
        ...
        global email_id
        email_id = userinfo_data.get('email')
